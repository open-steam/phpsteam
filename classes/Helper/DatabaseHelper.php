...
class DatabaseHelper
{
    ...
    public function get_document_attributes($id)
    {
        $mysql_data = array();
        $data = array();
        $rs = "";
    ...
    public function countMails($userName = "")
    {
        ...
        public function check_permissions($user, $oid, $password)
    {
    ...
    public function is_modified($last_modified_server, $last_modified_http)
    {
    ...
    public function get_last_modified($oid)
    {
        $query = "select ob_id from ob_data where ob_attr='OBJ_PATH' and ob_data='\"" . $path . "\"'";
        $result = mysql_query($query);
        if (!$result) return "";
    ...
    public function get_mime_type($oid)
    {
