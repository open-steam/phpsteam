...
class steam_connector {
	...
	public static function get_instance($id) {
		if (!is_string($id)) {
			throw new ParameterException("id", "string");
		}
	 ...
	 */
	public function send_mail_from($target, $subject, $message, $from, $buffer = FALSE, $mime_type = "text/html") {
	 ...
	 * yourself
	 */
	public function quoted_printable_encode($string, $encoding = 'UTF-8') {
